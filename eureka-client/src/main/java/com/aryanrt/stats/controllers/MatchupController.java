...
public class MatchupController{
  ...
  public List<Matchup> all(HttpServletRequest request)
  {
	  return matchupService.findAll();
...
//	    return result;
  ...
  public Matchup one(@PathVariable int id, HttpServletRequest request) {
	  return matchupService.findOne(id);
//
//		  String baseURL = request.getRequestURL().toString().replace(request.getRequestURI(), request.getContextPath());
//		  
