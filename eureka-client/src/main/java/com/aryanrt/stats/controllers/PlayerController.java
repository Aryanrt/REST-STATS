...
public class PlayerController {
	...
	List<Player> all(HttpServletRequest request) 
	{
		return this.playerServiceImpl.finalAll();
	}
//  @GetMapping(value="/players",produces="application/json")
...
//  }
	...
	Player one(@PathVariable int id, HttpServletRequest request)
	{
		return playerServiceImpl.findOne(id);
	}
