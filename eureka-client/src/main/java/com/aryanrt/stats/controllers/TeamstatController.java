...
import com.aryanrt.stats.service.impl.TeamstatServiceImpl;
...
public class TeamstatController {
	...
	private TeamstatServiceImpl teamstatServiceImpl;

	public TeamstatController(TeamstatServiceImpl teamstatServiceImpl) {
		super();
		this.teamstatServiceImpl = teamstatServiceImpl;
	}

	@GetMapping(value="/teamstats",produces="application/json")
	public List<Teamstat> all(HttpServletRequest request)
	{
		return teamstatServiceImpl.finaAll();
	}

	@GetMapping(value="/teamstats/{teamID}/{gameID}",produces="application/json")
	public Teamstat one(@PathVariable String teamID, @PathVariable String gameID, HttpServletRequest request) {
		return teamstatServiceImpl.findOne(teamID, Integer.parseInt(gameID));
